...
const form = {
  ...
  codecs: {
    video: [
      { name: 'x264', value: 'x264', supported: ['mp4', 'mkv', 'avi', 'mpegts', 'dash', 'hls'] },
      { name: 'x265', value: 'x265', supported: ['mp4', 'mkv', 'avi', 'mpegts', 'dash', 'hls'] },
      { name: 'h264_nvenc (Nvidia NVENC)', value: 'h264_nvenc', supported: ['mp4', 'mpegts', 'dash', 'hls'] },
      { name: 'hevc_nvenc (Nvidia NVENC)', value: 'hevc_nvenc', supported: ['mp4', 'mpegts', 'dash', 'hls'] },
